...
public class NotesService {
    ...
    public Note createNote(Note note){
        ...
        if(note.getId() != null && notesRepo.existsById(note.getId())){
            throw new IllegalArgumentException("Note with the id: " + note.getId() + " already exists!");
        }
        // Ensure id is null so that it can be autogenerated
        note.setId(null);
