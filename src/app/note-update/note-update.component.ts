...
@Component({
  ...
  imports: [FormsModule],
  template: `
    <form class="form" #updateForm = "ngForm" (ngSubmit) = "updateNote()">
      ...
      <button id="update-button"type="submit" [disabled]="!updateForm.form.valid">Update</button>
    </form>
  `,
...
export class NoteUpdateComponent implements OnInit{
  ...
  updateNote(){
    let note:NoteUpdateDTO = {title:this.title,text:this.text}
